...
class Pin extends Graphics {
  type = 'pin'
  pinUrl: string
  defaultPinUrl = 'https://zouyaoji.top/vue-cesium/images/mark-icon.png'
  constructor(
    ...
    this.defaultColor = Cesium.Color.RED.clone()
    this.pinUrl = this._options?.pinUrl ?? this.defaultPinUrl
  }
